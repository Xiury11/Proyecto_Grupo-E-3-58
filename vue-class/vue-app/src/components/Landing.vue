<template>
  ...
  <main id="main">
  <section id="password" class="hero d-flex align-items-center">
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center">
            ...
            <div class="container overflow-hidden">
              ...
              <div class="col-md-6 form-group pr-md-1">
                ...
                <input type="text" name="name" class="form-control" id="email" placeholder="*******@mail.com" required>
              </div>

              <div class="col-md-6 form-group pr-md-1">
                <h5>Se le enviara un correo con un codigo para que pueda reestablecer su contraseña</h5>
                <input type="text" name="name" class="form-control" id="name" placeholder="Digite el codigo" required>
              </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 ">
              ...
              <div class="container overflow-hidden">
                <div class="col-md-6 ">
                  <input type="number" name="ingreso" class="form-control" id="ingreso" placeholder="Valor del ingreso" required>
                </div>
                <div class="col-md-6 ">
                  <input type="text" name="desc_ingreso" class="form-control" id="desc_ingreso" placeholder="Descripción del ingreso" required>
                </div>
                <div class="col-md-6 ">
                  <select  id="clasificacion_ingreso">
...
.hero .btn-get-started {
  ...
  background: #d09306;
  box-shadow: 0px 5px 30px rgba(233, 235, 113, 0.4);
}

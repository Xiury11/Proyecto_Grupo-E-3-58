        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <form action="forms/notify.php" method="post" role="form" class="php-email-form">
            ...
            <div class="col-lg-6 ">
              ...
              <a href="#" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center" type="bitton" @click="login">
...
export default {
    ...
    methods: {
        login(){
                ...
                //axios.post('https://gastos1.herokuapp.com/login',formData,{
                    headers:{
